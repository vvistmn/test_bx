...
<div class="news-detail">
	...
	<?if($arParams["DISPLAY_NAME"]!="N" && $arResult["NAME"]):?>
        ...
        <?if($arParams["REPORT_AJAX"] == "Y"):?>
            <a id="ajax_link" href="#" onclick="return false;">Пожаловаться!</a>
            <script>
                BX.ready(function () {
                    var ajaxReportBtn = document.getElementById('ajax_link');
                    var textElem = document.getElementById('ajax_text');
        ...
        <?endif;?>
        <span id="ajax_text"></span>


	<?endif;?>
    <span id="report_news_text"></span>
	<div class="news-detail">
